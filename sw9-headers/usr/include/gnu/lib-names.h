...
#define LIBBROKENLOCALE_SO              "libBrokenLocale.so.1.1"
#define LIBCIDN_SO                      "libcidn.so.1"
#define LIBCRYPT_SO                     "libcrypt.so.1.1"
#define LIBC_SO                         "libc.so.6.1"
#define LIBDL_SO                        "libdl.so.2.1"
#define LIBGCC_S_SO                     "libgcc_s.so.1"
#define LIBMVEC_SO                      "libmvec.so.1"
#define LIBM_SO                         "libm.so.6.1"
#define LIBNSL_SO                       "libnsl.so.1.1"
...
#define LIBRESOLV_SO                    "libresolv.so.2.1"
#define LIBRT_SO                        "librt.so.1"
#define LIBTHREAD_DB_SO                 "libthread_db.so.1"
#define LIBUTIL_SO                      "libutil.so.1.1"
