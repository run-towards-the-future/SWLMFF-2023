#ifndef _SW_64_SWAB_H
#define _SW_64_SWAB_H
...
static __inline__  __u32 __arch_swab32(__u32 x)
{
	 ...
	 * on sw2 since the latency of the UNPKBW is 3, which is
	...
	t0 = __kernel_ins6b(x, 7);	/* t0 : 0000000000AABBCC */
	t1 = __kernel_ins1b(x, 3);	/* t1 : 000000CCDD000000 */
