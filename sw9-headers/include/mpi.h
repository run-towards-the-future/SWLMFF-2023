...
/* Add by YXH for LINPACK, 2020-07-01 */
#if defined LINPACK_CG_FUSE

extern void *xmalloc(unsigned long size);
extern void xfree(void *ptr);
extern void *xrealloc(void *ptr, unsigned long size);
extern void *xvalloc(unsigned long size);
extern void *xmemalign(unsigned long alignment, unsigned long size);
...
/*Added by WD in 2018-01-23*/
#define MPI_COMM_INTRA_REGION	((MPI_Comm)0x44000003)
#define MPI_COMM_INTER_REGION	((MPI_Comm)0x44000004)
 ...
 */
#define MPICH_VERSION "3.2b2"
#define MPICH_NUMVERSION 30200102
