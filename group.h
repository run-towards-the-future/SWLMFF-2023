...
class Group : protected Pointers {
 public:
  ...
  void xcmone(int, double, double *);    // center-of-mass coords of group
  void xcm(int, double, double *, int);
  void vcm(int, double, double *);    // center-of-mass velocity of group
  void vcmone(int, double, double *);    // center-of-mass coords of group
  ...
  void angmom_one(int, double *, double *);    // angular momentum of group
  ...
  void inertia_one(int, double *, double[3][3]);    // inertia tensor
